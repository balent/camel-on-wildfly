...
public class ServletSedaTestIT {
    private static final String URL_REQUEST = "http://localhost:8080/camel-example-servlet-seda-no-spring/camel/hello-seda-no-spring-request";
    private static final String URL_RESPONSE = "http://localhost:8080/camel-example-servlet-seda-no-spring/camel/hello-seda-no-spring-response";
