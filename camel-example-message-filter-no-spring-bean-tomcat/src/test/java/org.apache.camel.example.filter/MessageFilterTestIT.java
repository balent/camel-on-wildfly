...
public class MessageFilterTestIT {
    private static final String URL_REQUEST = "http://localhost:8080/camel-example-message-filter-no-spring-bean-tomcat/camel/hello-filter-no-spring-request";
    private static final String URL_RESPONSE = "http://localhost:8080/camel-example-message-filter-no-spring-bean-tomcat/camel/hello-filter-no-spring-response";
