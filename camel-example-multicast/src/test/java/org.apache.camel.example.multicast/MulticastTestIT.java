...
public class MulticastTestIT {
    private static final String URL_REQUEST = "http://localhost:8080/camel-example-multicast/camel/hello-multicast-request";
    private static final String URL_RESPONSE = "http://localhost:8080/camel-example-multicast/camel/hello-multicast-response";
