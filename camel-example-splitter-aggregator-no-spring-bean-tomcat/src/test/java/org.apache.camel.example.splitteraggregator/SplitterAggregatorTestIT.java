...
public class SplitterAggregatorTestIT {
    private static final String URL_REQUEST = "http://localhost:8080/camel-example-splitter-aggregator-no-spring-bean-tomcat/camel/hello-splitter-no-spring-request";
    private static final String URL_RESPONSE = "http://localhost:8080/camel-example-splitter-aggregator-no-spring-bean-tomcat/camel/hello-splitter-no-spring-response";
