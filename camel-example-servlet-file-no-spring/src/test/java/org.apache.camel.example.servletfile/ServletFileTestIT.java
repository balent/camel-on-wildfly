...
public class ServletFileTestIT {
    private static final String URL_REQUEST = "http://localhost:8080/camel-example-servlet-file-no-spring/camel/hello-file-request";
    private static final String URL_RESPONSE = "http://localhost:8080/camel-example-servlet-file-no-spring/camel/hello-file-response";
