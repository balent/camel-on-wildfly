...
public class MessageFilterTestIT {
    private static final String URL_REQUEST = "http://localhost:8080/camel-example-message-filter/camel/hello-filter-request";
    private static final String URL_RESPONSE = "http://localhost:8080/camel-example-message-filter/camel/hello-filter-response";
