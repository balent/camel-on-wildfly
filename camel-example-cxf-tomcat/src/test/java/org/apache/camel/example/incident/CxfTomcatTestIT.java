 ...
 */
package org.apache.camel.example.incident;
...
public class CxfTomcatTestIT {
    ...
    @Test
    public void testsDeployedWS() throws Exception {
        ...
        Assert.assertEquals("OK;123", out.getCode());
        ...
        Assert.assertEquals("IN PROGRESS", outStatus.getStatus());
    }
}
