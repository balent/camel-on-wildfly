...
public class ServletTomcatTestIT {
    private static final String URL_WITH_PARAM = "http://localhost:8080/camel-example-servlet-tomcat-no-spring/camel/hello?name=Robert";
    private static final String URL_DEFAULT = "http://localhost:8080/camel-example-servlet-tomcat-no-spring/camel/hello";
